#ifndef PGEN_TURB_VEL_HPP_
#define PGEN_TURB_VEL_HPP_
//========================================================================================
...
class TurbulenceVel {
 public:
  TurbulenceVel(std::string bk, MeshBlockPack *pp, ParameterInput *pin);
  ~TurbulenceVel();
 ...
 private:
  ...
  MeshBlockPack* pmy_pack;  // ptr to MeshBlockPack containing this TurbulenceVel
};
...
//  \brief implementation of functions in TurbulenceVel
...
TurbulenceVel::TurbulenceVel(std::string bk, MeshBlockPack *pp, ParameterInput *pin) :
  pmy_pack(pp),
...
TaskStatus TurbulenceVel::InitializeModes(int stage) {
  auto &indcs = pmy_pack->pmesh->mb_indcs;
