#ifndef PGEN_TURB_DENS_HPP_
#define PGEN_TURB_DENS_HPP_
//========================================================================================
...
//----------------------------------------------------------------------------------------
//! \class TurbulenceDens

class TurbulenceDens {
 public:
  TurbulenceDens(std::string bk, MeshBlockPack *pp, ParameterInput *pin);
  ~TurbulenceDens();
  ...
  TaskStatus AddTurbing(int stage);

 private:
  bool first_time=true;     // flag to enable initialization on first call
  MeshBlockPack* pmy_pack;  // ptr to MeshBlockPack containing this TurbulenceDens
};
...
//  \brief implementation of functions in TurbulenceDens
...
TurbulenceDens::TurbulenceDens(std::string bk, MeshBlockPack *pp, ParameterInput *pin) :
  pmy_pack(pp),
...
TaskStatus TurbulenceDens::InitializeModes(int stage) {
  auto &indcs = pmy_pack->pmesh->mb_indcs;
