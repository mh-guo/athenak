...
void MonopoleFluxes(HistoryData *pdata, Mesh *pm) {
  ...
  std::string data_label[nflux] = {"r","area","out","m","mout","mdot","mdotout","edot",
    "edotout","lx","ly","lz","lzout","phi","eint","b^2","u0","u_0","ur","uph","b0",
    "b_0","br","bph","edothyd","edho","edotadv","edao","omegab"
  };
  int gi0 = 0;
  if (pm->pzoom != nullptr) {
    gi0 = 1;
